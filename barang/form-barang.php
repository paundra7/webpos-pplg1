            ...
            <div class="row">
              <div class="col-lg-8 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" name="username" id="username" class="form-control" placeholder="Kode"
                ...
                <div class="form-group">
                  ...
                  <input type="nama_barang" name="nama_barang" id="nama_barang" class="form-control"
                    placeholder="Nama" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="harga_beli" name="harga_beli" id="harga_beli" class="form-control"
                    placeholder="Rp 0" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
                  <label for="address">Harga Jual*</label>
                  <input type="harga_jual" name="harga_jual" id="harga_jual" class="form-control"
                    placeholder="Rp 0" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
              ...
              <div class="col-lg-4 text-center">
                <img src="<?= $main_url ?>assets/image/15710263_781b58d6-0730-4921-af85-e4add388ea7f_505_505 (1).jpeg" class="profile-user-img img-circle mb-3" alt="User">
